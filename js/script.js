...
function buttons() {
  var actions = ["Aerobic/Cardio Exercise", "Affectionate", "Agreement", "Analyze", "Angry Movements", "Annoy/Insult", "Arrive", "Balance", "Bend", "Bleed", "Bite", "Carry", "Challenge", "Clean", "Climb", "Close", "Confusion", "Cook", "Cool/Freeze", "Cover", "Creative Arts", "Crime", "Cut", "Decrease", "Desisive Movements", "Die", "Dirty", "Discipline", "Disgust", "Drop", "Eat/Drink", "Fall", "Fearful Movements", "Feeling Positive", "Financial Transaction", "Finger Movement", "Float/Water Movement", "Follow", "Forced Entry", "Gather", "Give", "Grab", "Grow", "Hand Dancing", "Hand Movement - Shake", "Heat/Light Up/Ignite", "Ignore", "Imitate", "Increase", "Inform", "Insert", "Jailed", "Kick", "Kidnap", "Kill", "Leadership Movements", "Learn", "Lift", "Limp", "Listen", "Maintenance", "Material Damage", "Mechanical Operation", "Mouth Movements", "Neutral Hands Connecting With Something", "No Movement", "Non-Life Threatening Bodily Harm", "Non-Verbal Sound From Mouth", "Open", "Organize (Objects)", "Pain (Feel)", "Persuade", "Poke/Tap", "Preserve/Protect", "Pull", "Push", "Quicken", "Read", "Realization", "Redo", "Reject", "Relax", "Relief (Feel)", "Relief (Provide)", "Remove/Send Away/Leave", "Resist", "Reverse", "Rise", "Rub", "Run", "Sadness", "Scrape", "Search", "Separate", "Sexual Attraction", "Shiver", "Shoot", "Show Something", "Sit", "Slow", "Smell", "Social Movements (Inclusive)", "Stimulate", "Stumble", "Succeed", "Sway", "Take", "Throw", "Threaten", "To March/Skip", "To Scare", "Touch", "Trust", "Twist/Turn", "Uncover", "Verbal Speech", "Walk", "Watch", "Wish to Create Positive Emotions", "Write/Document"];
